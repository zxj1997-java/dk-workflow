...
import vip.lsjscl.flowboot.starter.flow.entity.*;
import vip.lsjscl.flowboot.starter.flow.model.Edge;
import vip.lsjscl.flowboot.starter.flow.model.FlowDiagram;
import vip.lsjscl.flowboot.starter.flow.model.Node;
import vip.lsjscl.flowboot.starter.flow.repository.*;
